      ...
      <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('penjualan.index') }}" class="btn btn-warning float-right"><i class="fa-solid fas fa-backward"></i></a>
                @if (session('success'))
            ...
            <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody id="penjualann">
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-danger" onclick="hapusProduk(this)"><i class="fa-solid fas fa-trash"></i></button>
                            </td>
                        </tr>
                    </tbody>
                    <tfoot>
                ...
                <button type="button" class="btn btn-primary mt-2" onclick="tambahProduk()"><i class="fa-solid fas fa-plus"></i></button>
            </div>
            <div class="card-footer">
                <button type="submit" class="btn btn-primary"><i class="fa-solid fas fa-bookmark"></i></button>
            </div>    
        </form>
        </div>
      </div>
